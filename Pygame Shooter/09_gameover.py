...
def show_go_screen():
	...
	draw_text(screen, "(¡Ayuda a Goku a salvar la tierra de los temibles villanos!)", 27, WIDTH // 2, HEIGHT // 2)
	draw_text(screen, "Presiona ENTER para empezar", 17, WIDTH // 2, HEIGHT * 3/4)
	pygame.display.flip()
	waiting = True
	while waiting:
		clock.tick(60)
